...
namespace StudentsManagement {
    ...
    public partial class schooldbDataSet : global::System.Data.DataSet {
        ...
        public partial class studentsDataTable : global::System.Data.TypedTableBase<studentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentsRow AddstudentsRow(int idstudents, string name, System.DateTime birthdate, string address) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentsRow FindByidstudents(int idstudents) {
        ...
        public partial class studentsRow : global::System.Data.DataRow {
            ...
            public int idstudents {
                get {
                    return ((int)(this[this.tablestudents.idstudentsColumn]));
                }
                set {
                    this[this.tablestudents.idstudentsColumn] = value;
                }
            }
...
namespace StudentsManagement.schooldbDataSetTableAdapters {
    ...
    public partial class studentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `students` WHERE ((`idstudents` = @p1) AND ((@p2 = 1 AND `name` IS NU" +
                "LL) OR (`name` = @p3)) AND ((@p4 = 1 AND `birthdate` IS NULL) OR (`birthdate` = " +
                "@p5)) AND ((@p6 = 1 AND `address` IS NULL) OR (`address` = @p7)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `students` (`idstudents`, `name`, `birthdate`, `address`) VALUES (@p1" +
                ", @p2, @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `students` SET `idstudents` = @p1, `name` = @p2, `birthdate` = @p3, `address` = @p4 WHERE ((`idstudents` = @p5) AND ((@p6 = 1 AND `name` IS NULL) OR (`name` = @p7)) AND ((@p8 = 1 AND `birthdate` IS NULL) OR (`birthdate` = @p9)) AND ((@p10 = 1 AND `address` IS NULL) OR (`address` = @p11)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `idstudents`, `name`, `birthdate`, `address` FROM `students`";
        ...
        public virtual int Update(int p1, string p2, global::System.Nullable<global::System.DateTime> p3, string p4, int p5, string p7, global::System.Nullable<global::System.DateTime> p9, string p11) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p2, global::System.Nullable<global::System.DateTime> p3, string p4, int p5, string p7, global::System.Nullable<global::System.DateTime> p9, string p11) {
